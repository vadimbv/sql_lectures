# 📝 7 задач по SQL - разные уровни сложности

---

## Задача 1: Базовый JOIN с фильтрацией
...
## Задача 3: INNER JOIN, GROUP BY, HAVING и CASE
...
## Задача 4: Несколько JOIN'ов, GROUP BY, агрегация
...
## Задача 5: Оконные функции, ROW_NUMBER, рейтинг
...
## Задача 6: LAG/LEAD, GROUP BY, CASE, оконные функции
...
## Задача 7: Комплексный запрос (JOINs + оконные функции + CASE + COALESCE)
